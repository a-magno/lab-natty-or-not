...
O Mestre de Mesa (MM) é responsável por narrar a história, criar desafios e controlar os NPCs (Personagens Não-Jogadores) e dinossauros selvagens. As funções do MM incluem:
